...
Route::middleware(['setData', 'auth', 'SetSessionData', 'language', 'timezone', 'AdminSidebarMenu', 'CheckUserLogin'])->group(function () {
   ...
   Route::get('/clientes/{id}/estado-cuenta',
    ...
    Route::get('/clientes/{id}/estado-cuenta-final',
        [ContactController::class,'estadoCuentaFinal']
    ...
    //REPORTE DE COMPRAS
    Route::get(
        'clientes/{cliente}/reporte-compras',
    ...
    Route::get(
        '/historial-importaciones/{transaction}/excel',
        [ImportacionMasivaController::class, 'excel']
    )->name('historial-importaciones.excel');

    Route::get(
        '/historial-importaciones/{transaction}/pdf',
